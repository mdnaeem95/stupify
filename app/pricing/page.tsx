    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 via-blue-50 to-white">
      ...
      <div className="max-w-5xl mx-auto px-4 pb-20">
        <div className="grid md:grid-cols-2 gap-8">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-700">
                  <strong>10 questions per day</strong> - Perfect for trying out
                </span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">
                  <strong>3 simplicity levels</strong> - From 5yo to advanced
                </span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700">
                  <strong>Save conversations</strong> - Access your chat history
                </span>
              </li>
              <li className="flex items-start gap-3">
          ...
          {/* Premium Plan */}
          <div className="bg-gradient-to-br from-purple-600 to-blue-600 rounded-3xl shadow-2xl border-2 border-purple-400 p-8 relative overflow-hidden">
            {/* Popular Badge */}
            ...
            <div className="text-center mb-6 text-white">
              ...
              <p className="opacity-90">Unlimited learning, unlimited questions</p>
            </div>
            ...
            <ul className="space-y-4 mb-8 text-white">
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong>Unlimited questions</strong> - Ask as much as you want, anytime
                </span>
              </li>
              <li className="flex items-start gap-3">
                <Zap className="w-6 h-6 text-yellow-300 flex-shrink-0 mt-0.5" />
                <span>
                  <strong>Priority AI responses</strong> - Faster answers during peak times
                </span>
              </li>
              <li className="flex items-start gap-3">
                <Crown className="w-6 h-6 text-yellow-300 flex-shrink-0 mt-0.5" />
                <span>
                  <strong>Unlimited chat history</strong> - Never lose a conversation
                </span>
              </li>
              <li className="flex items-start gap-3">
            ...
            <Button 
              size="lg" 
              className="w-full bg-white text-purple-600 hover:bg-gray-100 text-lg font-bold h-14 shadow-lg"
      ...
      <div className="bg-white py-20">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="space-y-6">
            ...
            <div className="border-b pb-6">
              <h3 className="text-xl font-bold mb-2">What happens to my conversations if I downgrade?</h3>
              <p className="text-gray-700">
            ...
            <div className="border-b pb-6">
              <h3 className="text-xl font-bold mb-2">Is this really unlimited?</h3>
              <p className="text-gray-700">
            ...
            <div className="border-b pb-6">
              <h3 className="text-xl font-bold mb-2">How does the 30-day guarantee work?</h3>
              <p className="text-gray-700">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 py-20">
        <div className="max-w-4xl mx-auto px-4 text-center text-white">
          ...
          <Button 
            size="lg" 
            className="bg-white text-purple-600 hover:bg-gray-100 text-lg font-bold px-12 h-16"
            onClick={handleUpgrade}
            disabled={isLoading}
          >
