...
const DialogHeader = ({
  ...
  <div
    className={cn(
      'flex flex-col space-y-3 text-center sm:text-left pr-8',
      className
    )}
    {...props}
  />
